...
import kotlinx.android.synthetic.main.fragment_toning_power.*
...
class ToningPowerFragment : Fragment() {
    //    private val onTime = 5
    private val onTime = 60

    //    private val roundOffTime = 4
    private val roundOffTime = 45

    //    private val circuitOffTime = 10
    private val circuitOffTime = 60

    //    private val roundNr = 1
    private val roundNr = 4
    private var roundNrCountdown = 1
    private val circuitNr = 3
    private var circuitNrCountDown = 1

    enum class TimerState {
        Stopped, Paused, Resting, Running1, Running2
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_toning_power, container, false)
    }
    ...
    private fun onTimerFinished() {
        ...
        when (timerState) {
            TimerState.Running1 -> {
                ...
                timerState = TimerState.Running2
            ...
            TimerState.Stopped -> {
                previousTimerState = timerState
                timerState = TimerState.Running1
                action_text_view.text = resources.getString(R.string.go)
                secondsRemaining = onTime.toLong()
                timerLengthSeconds = onTime.toLong()
            }
